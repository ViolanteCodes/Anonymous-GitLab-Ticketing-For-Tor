...
from anonticket.views import CreateIdentifierView, UserLandingView, IssueSuccessView
...
urlpatterns = [
    ...
    path('user/<str:user_identifier>/create_issue/', views.create_issue, name='create-issue'),
